import { createTokens, Variable } from "tamagui";
...
const lightColors = {
  elevation: themes.light.elevation_level0,
  ...semanticLight,
  ...grayLight,
  ...purpleLight,
};
const darkColors = { elevation: themes.dark.elevation_level0, ...semanticDark, ...grayDark, ...purpleDark };
...
} satisfies Record<SizeKeysWithNegatives, number>;
